...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[Assert\GreaterThanOrEqual(value: 0, message: "The promotion coins be less than 0")]
    #[Assert\LessThanOrEqual(value: 999999999999999999, message: "The promotion coins be greater than 999999999999999999")]
    #[ORM\Column(type: 'bigint', options: [ "unsigned" => true ])]
    #[Groups(groups: ['user_private', 'api_edit', 'user_anti_cr'])]
    private int $coins = 0;

    #[Assert\GreaterThanOrEqual(value: 0, message: "The promotion xp be less than 0")]
    #[Assert\LessThanOrEqual(value: 999999999999999999, message: "The promotion xp be greater than 999999999999999999")]
    #[ORM\Column(type: 'bigint', options: [ "unsigned" => true ])]
